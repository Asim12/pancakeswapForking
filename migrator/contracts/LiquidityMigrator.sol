...
contract LiquidityMigrator {
	...
	constructor(address _router, address _pair, address _routerFork, address 
_pairFork, address _bonusToken) public {
	...
	function migrate() external  {
		...
		router.removeLiquidity( address(token0), address(token1), totalBalance, 
